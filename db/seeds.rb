...
products = [
  ...
  { id: 13, 
	name: 'Переходы стальные в ППУ изоляции в оболочке из полиэтилена',                                         
  ...
  { id: 15, 
	name: 'Переходные элементы для стыковки изделий с обычными трубопроводами',                                         
...
seometa = [
  ...
  { id: 14, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 11 },
  { id: 15, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 12 },
  { id: 16, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 13 },
  { id: 17, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 14 },
  { id: 18, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 15 },
  { id: 19, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 16 },
  { id: 20, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 17 },
  { id: 21, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 18 },
  { id: 22, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 19 },
  { id: 23, keywords: 'Type of product meta key words', 		description: 'Type of product meta description', type_of_product_id: 20 },
  { id: 24, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 1 },
  { id: 25, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 2 },
  { id: 26, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 3 },
  { id: 27, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 4 },
  { id: 28, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 5 },
  { id: 29, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 6 },
  { id: 30, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 7 },
  { id: 31, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 8 },
  { id: 32, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 9 },
  { id: 33, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 10 },
  { id: 34, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 11 },
  { id: 35, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 12 },
  { id: 36, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 13 },
  { id: 37, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 14 },
  { id: 38, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 15 },
  { id: 39, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 16 },  
  { id: 40, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 17 },
  { id: 41, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 18 },
  { id: 42, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 19 },
  { id: 43, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 20 },
  { id: 44, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 21 },
  { id: 45, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 22 },
  { id: 46, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 23 },
  { id: 47, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 24 },
  { id: 48, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 25 },
  { id: 49, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 26 },  
  { id: 50, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 27 },
  { id: 51, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 28 },
  { id: 52, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 29 },


  { id: 60, keywords: 'Service meta key words',         		description: 'Service meta description', service_id: 4 },
  { id: 61, keywords: 'Service meta key words',         		description: 'Service meta description', service_id: 5 },
  { id: 62, keywords: 'Service meta key words',         		description: 'Service meta description', service_id: 6 },
  { id: 63, keywords: 'Service meta key words',         		description: 'Service meta description', service_id: 7 },
  { id: 64, keywords: 'Service meta key words',         		description: 'Service meta description', service_id: 8 },
  { id: 65, keywords: 'Service meta key words',         		description: 'Service meta description', service_id: 9 },
]

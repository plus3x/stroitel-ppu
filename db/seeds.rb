...
seometa = [
  ...
  { id: 12, keywords: 'Термоусаживающиеся муфты, муфты, монтаж муфт, муфты термоусаживаемые, муфта соединительная для труб,  термоусадочная муфта, муфта концевая термоусаживаемая, производство муфт, муфта пэ, производители муфт, муфты трубопроводов, муфты для сшитого полиэтилена, муфта соединительная термоусаживаемая, монтаж концевых муфт, монтаж муфты концевой', 		description: 'Муфты термоусаживаемые от производителя, отличающаяся высокой прочностью.', type_of_product_id: 12 },
  ...
  { id: 50, keywords: 'Product meta key words',         description: 'Product meta description', product_id: 30 },
	...
	{ id: 51, keywords: 'Трубы ППУ +от производителя, псф строитель, строитель ппу, трубы ппу производитель, изоляция труб, производство труб, трубы полипропиленовые, труба полиэтилен, трубы пэ',        	description: 'ПСФ Строитель – динамично развивающееся предприятие, осуществляющее производство современных трубопроводов', service_id: 1 },

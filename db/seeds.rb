...
seometa = [
  ...
  { id: 51, keywords: 'Трубы ППУ +от производителя, псф строитель, строитель ппу, трубы ппу производитель, изоляция труб, теплоизоляция труб, производство труб',        	description: 'Компания ПСФ Строитель – динамично развивающееся предприятие, осуществляющее производство современных трубопроводов', service_id: 1 },

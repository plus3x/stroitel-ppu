...
seometa = [
  ...
  { keywords: 'отводы +в ппу изоляции, вес отводов +в ппу изоляции, отвод стальной +в изоляции ппу',          description: 'Отводы в ППУ изоляции', type_of_product_id: 1 },
  { keywords: 'тройник +в ппу изоляции, тройник +в ппу',        description: 'Тройники в ППУ изоляции', type_of_product_id: 2 },
  { keywords: 'Тройниковые ответвления, тройниковое ответвление +в ппу, тройниковые ответвления +в оц',         description: 'Тройниковые ответвления', type_of_product_id: 3 },
  { keywords: 'Тройники параллельные,тройник параллельный',     description: 'Тройник параллельный', type_of_product_id: 4 },
  { keywords: 'Z-образные элементы, z образный элемент',    description: 'Z-образные элементы', type_of_product_id: 5 },
  { keywords: 'Непроходной канал, каналы непроходные кн, канал непроходной кн, прокладка трубопроводов, непроходной канал размерых',    description: 'Непроходной канал (КН) применяются для прокладки инженерных сетей и коммуникаций.', type_of_product_id: 6 },
  { keywords: 'Опорные подушки ппу,опорная подушка, оп ппу',     description: 'Опорные подушки', type_of_product_id: 7 },
  { keywords: 'Тепловые камеры, камеры тепловых сетей, камера тепловой сети, теплосети тепловая камера',     description: 'Тепловые камеры предназначены для оборудования узлов пересечения каких-либо сетей.', type_of_product_id: 8 },
  { keywords: 'Железо/бетонные кольца, кольца, жб кольца, ж/б кольца',     description: 'Железо/бетонные кольца для колодцев', type_of_product_id: 9 },
  { keywords: 'ппу, скорлупа, скорлупа ппу, пенополиуретан, теплоизоляция труб, крошка ппу, плита ппу', description: 'Скорлупа ППУ из пенополиуретана от производителя, скорлупа ппу для теплоизоляции труб', type_of_product_id: 10 },
  { keywords: 'термоусаживаемая лента, термоусадочная лента, лента термоусаживаемая, лента термоусадочная',     description: 'Tермоусаживаемая лента от производителя, отличающаяся высокой прочностью.', type_of_product_id: 11 },
  { keywords: 'Термоусаживающиеся муфты, муфты, муфты термоусаживаемые, муфта соединительная для труб,  термоусадочная муфта, производство муфт, муфта пэ, муфты трубопроводов, монтаж концевых муфт',    description: 'Муфты термоусаживаемые от производителя, отличающаяся высокой прочностью.', type_of_product_id: 12 },
  { keywords: 'Пенопакет Монтажный ПМб, пенопакет монтажный, пенопакет',    description: 'Пенопакет монтажный - несколько герметичных камер, содержащих компоненты ППУ. Между собой они разделяются перемычкой и оснащены специальной горловиной', type_of_product_id: 13 },
  { keywords: 'переходы в ппу',     description: 'Переходы ППУ для трубопроводов в ППУ изоляции от производителя', type_of_product_id: 14 },
  { keywords: 'компенсаторы, сильфонный компенсатор, осевой компенсатор, компенсатор сильфонный осевой, сильфонный компенсатор +в ппу',     description: 'Сильфонные компенсаторы позволяют исключить различные деформации на трубопроводах под влиянием перепада температур или вибраций', type_of_product_id: 15 },
  { keywords: 'Скользящие опоры, опора под скользящую опору,изготовление скользящих опор,скользящие +и неподвижные опоры, скользящие опоры ппу',    description: 'Скользящие опоры', type_of_product_id: 16 },
  { keywords: 'Неподвижные щитовые опоры, НЩО, опора неподвижная щитовая, неподвижные щитовые опоры +для трубопроводов, неподвижная щитовая опора ппу',     description: 'Неподвижные щитовые опоры', type_of_product_id: 17 },
  { keywords: 'Концевые элементы,концевые элементы ппу,концевой элемент трубопровода,концевой элемент',     description: 'Концевые элементы', type_of_product_id: 18 },
  { keywords: 'Type of product meta key words',     description: 'Type of product meta description', type_of_product_id: 19 },
  { keywords: 'Type of product meta key words',     description: 'Type of product meta description', type_of_product_id: 20 },
 
  { keywords: 'Product meta key words',         description: 'Product meta descRCJription', product_id: 1 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 2 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 3 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 4 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 5 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 6 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 7 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 8 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 9 },
  { keywords: 'Скорлупа ППУ, ппу скорлупа +для труб, скорлупы ппу изоляция труб, скорлупа ппу +для трубопроводов',         description: 'Пенополиуретановые скорлупы ППУ предназначены для изоляции труб, а также их стыков вместе с отводами и другими фасонными частями.', product_id: 10 },
  { keywords: 'z образные элементы, z образный элемент',         description: 'Z-образные элементы в ППУ изоляции в оболочке из полиэтилена', product_id: 11 },
  { keywords: 'z образные элементы, z образный элемент',         description: 'Z-образные элементы в ППУ изоляции в оболочке из оцинкованной стали', product_id: 12 },
  { keywords: 'переход ппу, переход +в ппу изоляции',         description: 'Переходы стальные в ППУ изоляции в оболочке из полиэтилена', product_id: 13 },
  { keywords: 'переход ппу, переход +в ппу изоляции',         description: 'Переходы в ППУ изоляции в оболочке из оцинкованной стали', product_id: 14 },
  { keywords: 'переходные элементы',         description: 'Переходные элементы для стыковки изделий с обычными трубопроводами', product_id: 15 },
  { keywords: 'Компенсатор сильфонный фланцевый, компенсаторы сильфонные фланцевые, компенсатор сильфонный фланцевый цена',         description: 'Компенсатор сильфонный фланцевый', product_id: 16 },  
  { keywords: 'Осевой сильфонный компенсатор, компенсатор сильфонный осевой, компенсатор сильфонный осевой ксо, КСО',         description: 'Осевой сильфонный компенсатор', product_id: 17 },
  { keywords: 'Компенсаторы сильфонные универсальные,  КСУ',         description: 'Компенсаторы сильфонные универсальные', product_id: 18 },
  { keywords: 'Опора скользящая хомутовая, хомутовая опора +для труб',         description: 'Опора скользящая хомутовая', product_id: 19 },
  { keywords: 'Опора скользящая приварная, опора скользящая приварная тс 623.000, приварная опора +для труб',         description: 'Опора скользящая приварная', product_id: 20 },
  { keywords: 'Опора скользящая ТС, опора скользящая, скользящая опора +для труб, скользящая опора +для труб ппу, опора скользящая направляющая',         description: 'Опора скользящая ТС', product_id: 21 },
  { keywords: 'Z-образные элементы, z образный элемент, оцинкованной стали',         description: 'Z-образные элементы в ППУ изоляции в оболочке из оцинкованной стали', product_id: 22 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 23 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 24 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 25 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 26 },  
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 27 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 28 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 29 },
  { keywords: 'Product meta key words',         description: 'Product meta description', product_id: 30 },
  ...
  { keywords: 'Фасонные изделия, фасонные изделия труб,фасонные изделия +для трубопроводов, фасонные изделия ппу,фасонные изделия +в ппу изоляции',                 description: 'Фасонные изделия', service_id: 2 },
  { keywords: 'элементы, теплотрасс, элементы теплотрасс, каналы, подушки, опорные подушки, тепловые камеры, жб кольца, ж/б кольца',            description: 'Элементы теплотрасс', service_id: 3 },
  { keywords: 'Service meta key words',             description: 'Service meta description', service_id: 4 },
  { keywords: 'Service meta key words',             description: 'Service meta description', service_id: 5 },
  { keywords: 'Service meta key words',             description: 'Service meta description', service_id: 6 },
  { keywords: 'Фильтр-патрон ФИПОС, ФИПОС-1,ФИПОС-2,ФИПОС-3,ФИПОС-4,Фильтр патрон, ФП, фп, фильтр патрон +для ливневой канализации',            description: 'Фильтр-патрон ФИПОС', service_id: 7 },
  { keywords: 'Service meta key words',             description: 'Service meta description', service_id: 8 },
  { keywords: 'Производство бытовок, бытовки, строительные бытовки, производство дачных бытовок, бытовки дачные, изготовление бытовок, сборка бытовок',             description: 'Производство бытовок', service_id: 9 },
  { keywords: 'футеровка пластиком, футеровка +ж +б колодцев, футеровка колодцев, футеровка оборудования, футеровка',             description: 'Футеровка ж/б колодцев', service_id: 10 },
  { keywords: 'Конструирование оборудования, изготовление станков, спирально навивные воздуховоды, воздуховоды',            description: 'Конструирование оборудования и изготовление станков, спирально-навивные воздуховоды', service_id: 11 },
]
